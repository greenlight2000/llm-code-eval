...
def parse_arguments():
    ...
    parser.add_argument('--data_load_name', default='program_synthesis_v3', type=str)
    parser.add_argument('--result_save_name', default='code_generation_eval_vicuna.jsonl',type=str)
    parser.add_argument('--log_file_name', default='code_generation_eval_vicuna.log',type=str),
