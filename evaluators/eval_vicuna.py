...
def parse_arguments():
    ...
    parser.add_argument('--result_save_name', default='code_test_data_vicuna.jsonl',
                        choices=['code_review_eval_vicuna.jsonl', 'code_smell_eval_vicuna.jsonl',
                                 'code_test_data_vicuna.jsonl'], type=str)
    parser.add_argument('--log_file_name', default='code_test_data_vicuna.log',
                        choices=['code_review_eval_vicuna.log', 'code_smell_eval_vicuna.log',
                                 'code_test_data_vicuna.log'], type=str)
...
if __name__ == '__main__':
    ...
    main()
    # python evaluators/eval_vicuna.py
