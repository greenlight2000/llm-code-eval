...
def valid_execfiles(exec_outcome_dir):
    ...
    for target_cluster in support_lang_clusters:
        for lang_cluster in support_lang_clusters:
            ...
            print(f"Pass rate from {lang_cluster} to {target_cluster}: {correct_num/exec_num} ")
    return exec_outcome
